...
(function (InspectTab) {
    ...
    InspectTab["Raw"] = "raw";
    InspectTab["Issue"] = "issue";
    InspectTab["Meta"] = "meta";
})(InspectTab || (InspectTab = {}));
var getStyles = Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["stylesFactory"])(function () {
    return {
        toolbar: Object(emotion__WEBPACK_IMPORTED_MODULE_4__["css"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      display: flex;\n      margin: 8px 0;\n      justify-content: flex-end;\n      align-items: center;\n    "], ["\n      display: flex;\n      margin: 8px 0;\n      justify-content: flex-end;\n      align-items: center;\n    "]))),
        dataFrameSelect: Object(emotion__WEBPACK_IMPORTED_MODULE_4__["css"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      flex-grow: 2;\n    "], ["\n      flex-grow: 2;\n    "]))),
        downloadCsv: Object(emotion__WEBPACK_IMPORTED_MODULE_4__["css"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n      margin-left: 16px;\n    "], ["\n      margin-left: 16px;\n    "]))),
    };
});
var PanelInspector = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(PanelInspector, _super);
    function PanelInspector(props) {
        var _this = _super.call(this, props) || this;
        _this.onDismiss = function () {
            Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_6__["getLocationSrv"])().update({
                query: { inspect: null },
                partial: true,
            });
        };
        _this.onSelectTab = function (item) {
            _this.setState({ tab: item.value || InspectTab.Data });
        };
        _this.onSelectedFrameChanged = function (item) {
            _this.setState({ selected: item.value || 0 });
        };
        _this.exportCsv = function (dataFrame) {
            var dataFrameCsv = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_7__["toCSV"])([dataFrame]);
            var blob = new Blob([dataFrameCsv], {
                type: 'application/csv;charset=utf-8',
            });
            Object(file_saver__WEBPACK_IMPORTED_MODULE_3__["saveAs"])(blob, dataFrame.name + '-' + new Date().getUTCDate() + '.csv');
        };
        _this.state = {
            data: [],
            selected: 0,
    ...
    PanelInspector.prototype.componentDidMount = function () {
        var _a, _b;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var panel, lastResult, metaDS, data, data_1, data_1_1, frame, key, ds, e_1_1;
            var e_1, _c;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        lastResult = panel.getQueryRunner().lastResult;
                        if (!lastResult) {
                            this.onDismiss(); // Usually opened from refresh?
                            return [2 /*return*/];
                        }
                        data = (_a = lastResult) === null || _a === void 0 ? void 0 : _a.series;
                        if (!data) return [3 /*break*/, 8];
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 6, 7, 8]);
                        data_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(data), data_1_1 = data_1.next();
                        _d.label = 2;
                    case 2:
                        if (!!data_1_1.done) return [3 /*break*/, 5];
                        frame = data_1_1.value;
                        key = (_b = frame.meta) === null || _b === void 0 ? void 0 : _b.datasource;
                        if (!key) return [3 /*break*/, 4];
                        return [4 /*yield*/, Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_6__["getDataSourceSrv"])().get(key)];
                    case 3:
                        ds = _d.sent();
    ...
    PanelInspector.prototype.renderMetadataInspector = function () {
        var _a;
        var _b = this.state, metaDS = _b.metaDS, data = _b.data;
        if (!metaDS || !((_a = metaDS.components) === null || _a === void 0 ? void 0 : _a.MetadataInspector)) {
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, "No Metadata Inspector");
        }
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(metaDS.components.MetadataInspector, { datasource: metaDS, data: data });
    };
    PanelInspector.prototype.renderDataTab = function (width, height) {
        var _this = this;
        var _a = this.state, data = _a.data, selected = _a.selected;
        var styles = getStyles();
        if (!data || !data.length) {
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, "No Data");
        }
        var choices = data.map(function (frame, index) {
            return {
                value: index,
        ...
        // Apply dummy styles
        var processed = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_7__["applyFieldOverrides"])({
            data: data,
            theme: app_core_config__WEBPACK_IMPORTED_MODULE_8__["config"].theme,
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.toolbar },
                choices.length > 1 && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.dataFrameSelect },
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Select"], { options: choices, value: choices.find(function (t) { return t.value === selected; }), onChange: this.onSelectedFrameChanged }))),
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.downloadCsv },
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Forms"].Button, { variant: "primary", onClick: function () { return _this.exportCsv(processed[selected]); } }, "Download CSV"))),
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Table"], { width: width, height: height, data: processed[selected] })));
    };
    PanelInspector.prototype.renderIssueTab = function () {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, "TODO: show issue form");
    };
    PanelInspector.prototype.render = function () {
        var _this = this;
        var panel = this.props.panel;
        var _a = this.state, last = _a.last, tab = _a.tab;
        if (!panel) {
            this.onDismiss(); // Try to close the component
            return null;
        }
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Drawer"], { title: panel.title, onClose: this.onDismiss },
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["TabsBar"], null, tabs.map(function (t) {
                return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["Tab"], { label: t.label, active: t.value === tab, onChangeTab: function () { return _this.onSelectTab(t); } });
            })),
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["TabContent"], null,
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_virtualized_auto_sizer__WEBPACK_IMPORTED_MODULE_2__["default"], null, function (_a) {
                    var width = _a.width, height = _a.height;
                    if (width === 0) {
                        return null;
                    }
                    return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { style: { width: width } },
                        tab === InspectTab.Data && _this.renderDataTab(width, height),
                        tab === InspectTab.Meta && _this.renderMetadataInspector(),
                        tab === InspectTab.Issue && _this.renderIssueTab(),
                        tab === InspectTab.Raw && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null,
                            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_5__["JSONFormatter"], { json: last, open: 2 })))));
                }))));
    };
    return PanelInspector;
...
/* harmony import */ var _state_PanelModel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../state/PanelModel */ "./public/app/features/dashboard/state/PanelModel.ts");
/* harmony import */ var _dashgrid_DashboardPanel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../dashgrid/DashboardPanel */ "./public/app/features/dashboard/dashgrid/DashboardPanel.tsx");
/* harmony import */ var _panel_editor_QueriesTab__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../panel_editor/QueriesTab */ "./public/app/features/dashboard/panel_editor/QueriesTab.tsx");
...
var getStyles = Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["stylesFactory"])(function (theme) { return ({
    wrapper: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(templateObject_1 || (templateObject_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n    width: 100%;\n    height: 100%;\n    position: fixed;\n    z-index: ", ";\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    background: ", ";\n    display: flex;\n    padding: ", ";\n    flex-direction: row;\n  "], ["\n    width: 100%;\n    height: 100%;\n    position: fixed;\n    z-index: ", ";\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    background: ", ";\n    display: flex;\n    padding: ", ";\n    flex-direction: row;\n  "])), theme.zIndex.modal, theme.colors.pageBg, theme.spacing.md),
    leftPane: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(templateObject_2 || (templateObject_2 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n    flex-grow: 1;\n    height: 100%;\n  "], ["\n    flex-grow: 1;\n    height: 100%;\n  "]))),
    rightPane: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(templateObject_3 || (templateObject_3 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n    width: 450px;\n    height: 100%;\n    flex-grow: 0;\n  "], ["\n    width: 450px;\n    height: 100%;\n    flex-grow: 0;\n  "]))),
    leftPaneViz: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(templateObject_4 || (templateObject_4 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n    width: 100%;\n    height: 50%;\n  "], ["\n    width: 100%;\n    height: 50%;\n  "]))),
    leftPaneData: Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(templateObject_5 || (templateObject_5 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n    width: 100%;\n    height: 50%;\n    padding-top: ", ";\n  "], ["\n    width: 100%;\n    height: 50%;\n    padding-top: ", ";\n  "])), theme.spacing.md),
}); });
var PanelEditor = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(PanelEditor, _super);
    function PanelEditor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = {};
        return _this;
    }
    PanelEditor.prototype.componentDidMount = function () {
        var panel = this.props.panel;
        var dirtyPanel = new _state_PanelModel__WEBPACK_IMPORTED_MODULE_5__["PanelModel"](panel.getSaveModel());
        this.setState({ dirtyPanel: dirtyPanel });
    };
    PanelEditor.prototype.render = function () {
        var dashboard = this.props.dashboard;
        var dirtyPanel = this.state.dirtyPanel;
        var styles = getStyles(app_core_config__WEBPACK_IMPORTED_MODULE_4__["default"].theme);
        if (!dirtyPanel) {
            return null;
        }
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.wrapper },
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.leftPane },
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.leftPaneViz },
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_dashgrid_DashboardPanel__WEBPACK_IMPORTED_MODULE_6__["DashboardPanel"], { dashboard: dashboard, panel: dirtyPanel, isEditing: false, isFullscreen: false, isInView: true })),
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.leftPaneData },
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_panel_editor_QueriesTab__WEBPACK_IMPORTED_MODULE_7__["QueriesTab"], { panel: dirtyPanel, dashboard: dashboard }),
                    ";")),
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: styles.rightPane }, "Visualization settings")));
    };
    return PanelEditor;
}(react__WEBPACK_IMPORTED_MODULE_1__["PureComponent"]));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _PanelEditor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PanelEditor */ "./public/app/features/dashboard/components/PanelEditor/PanelEditor.tsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PanelEditor", function() { return _PanelEditor__WEBPACK_IMPORTED_MODULE_0__["PanelEditor"]; });
...
/* harmony import */ var _components_PanelEditor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/PanelEditor */ "./public/app/features/dashboard/components/PanelEditor/index.ts");
...
/* harmony import */ var _components_Inspector_PanelInspector__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../components/Inspector/PanelInspector */ "./public/app/features/dashboard/components/Inspector/PanelInspector.tsx");
...
var DashboardPage = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DashboardPage, _super);
    ...
    DashboardPage.prototype.renderInitFailedState = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "dashboard-loading" },
            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_13__["Alert"], { severity: app_types__WEBPACK_IMPORTED_MODULE_17__["AppNotificationSeverity"].Error, title: initError.message, children: Object(app_core_utils_errors__WEBPACK_IMPORTED_MODULE_7__["getMessageFromError"])(initError.error) })));
    };
    DashboardPage.prototype.render = function () {
        var _a = this.props, dashboard = _a.dashboard, editview = _a.editview, $injector = _a.$injector, isInitSlow = _a.isInitSlow, initError = _a.initError, inspectPanelId = _a.inspectPanelId, urlEditPanel = _a.urlEditPanel;
        ...
        var inspectPanel = inspectPanelId ? dashboard.getPanelById(parseInt(inspectPanelId, 10)) : null;
        // find panel being edited
        var editPanel = urlEditPanel ? dashboard.getPanelById(parseInt(urlEditPanel, 10)) : null;
        ...
        return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: classes },
            ...
            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "scroll-canvas scroll-canvas--dashboard" },
                react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_13__["CustomScrollbar"], { autoHeightMin: "100%", setScrollTop: this.setScrollTop, scrollTop: updateScrollTop, updateAfterMountMs: 500, className: "custom-scrollbar--page" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: gridWrapperClasses },
                        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_SubMenu__WEBPACK_IMPORTED_MODULE_10__["SubMenu"], { dashboard: dashboard }),
            ...
            inspectPanel && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_Inspector_PanelInspector__WEBPACK_IMPORTED_MODULE_18__["PanelInspector"], { dashboard: dashboard, panel: inspectPanel }),
            editPanel && react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_PanelEditor__WEBPACK_IMPORTED_MODULE_12__["PanelEditor"], { dashboard: dashboard, panel: editPanel })));
    };
...
var DashboardGrid = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(DashboardGrid, _super);
    function DashboardGrid() {
        ...
        _this.onLayoutChange = function (newLayout) {
            var e_1, _a;
            try {
                for (var newLayout_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(newLayout), newLayout_1_1 = newLayout_1.next(); !newLayout_1_1.done; newLayout_1_1 = newLayout_1.next()) {
        ...
        _this.onWidthChange = function () {
            var e_2, _a;
            try {
                for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(_this.props.dashboard.panels), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var panel = _c.value;
                    panel.resizeDone();
                }
            }
    ...
    DashboardGrid.prototype.componentDidMount = function () {
        ...
        dashboard.on(app_types__WEBPACK_IMPORTED_MODULE_8__["CoreEvents"].repeatsProcessed, this.triggerForceUpdate);
        dashboard.on(_grafana_data__WEBPACK_IMPORTED_MODULE_9__["PanelEvents"].viewModeChanged, this.onViewModeChanged);
        dashboard.on(app_types__WEBPACK_IMPORTED_MODULE_8__["CoreEvents"].rowCollapsed, this.triggerForceUpdate);
        dashboard.on(app_types__WEBPACK_IMPORTED_MODULE_8__["CoreEvents"].rowExpanded, this.triggerForceUpdate);
    };
    DashboardGrid.prototype.componentWillUnmount = function () {
        ...
        dashboard.off(app_types__WEBPACK_IMPORTED_MODULE_8__["CoreEvents"].repeatsProcessed, this.triggerForceUpdate);
        dashboard.off(_grafana_data__WEBPACK_IMPORTED_MODULE_9__["PanelEvents"].viewModeChanged, this.onViewModeChanged);
        dashboard.off(app_types__WEBPACK_IMPORTED_MODULE_8__["CoreEvents"].rowCollapsed, this.triggerForceUpdate);
        dashboard.off(app_types__WEBPACK_IMPORTED_MODULE_8__["CoreEvents"].rowExpanded, this.triggerForceUpdate);
    };
    DashboardGrid.prototype.buildLayout = function () {
        ...
        this.panelMap = {};
        try {
            for (var _b = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(this.props.dashboard.panels), _c = _b.next(); !_c.done; _c = _b.next()) {
                var panel = _c.value;
...
//# sourceMappingURL=DashboardPage.6310f9af5345c722b930.js.map