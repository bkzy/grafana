...
/* harmony import */ var _response_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./response_parser */ "./public/app/plugins/datasource/mssql/response_parser.ts");



var MssqlDatasource = /** @class */ (function () {
    /** @ngInject */
    function MssqlDatasource(instanceSettings, backendSrv, templateSrv, timeSrv) {
    ...
    MssqlDatasource.prototype.interpolateVariablesInQueries = function (queries, scopedVars) {
        var _this = this;
...
var MssqlQueryCtrl = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(MssqlQueryCtrl, _super);
    /** @ngInject */
    function MssqlQueryCtrl($scope, $injector) {
        ...
        _this.panelCtrl.events.on(_grafana_data__WEBPACK_IMPORTED_MODULE_3__["PanelEvents"].dataReceived, _this.onDataReceived.bind(_this), $scope);
        _this.panelCtrl.events.on(_grafana_data__WEBPACK_IMPORTED_MODULE_3__["PanelEvents"].dataError, _this.onDataError.bind(_this), $scope);
        return _this;
    }
...
//# sourceMappingURL=mssqlPlugin.6310f9af5345c722b930.js.map